        ...
        mAuth.createUserWithEmailAndPassword(mEt_regEmail.getText().toString(),mEt_regPassword.getText().toString()).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    myRef.child("Dictionary").child("Users").child(uuid).child("EMail").setValue(mEt_regEmail.getText().toString());
                    myRef.child("Dictionary").child("Users").child(uuid).child("Username").setValue(mEt_regUsername.getText().toString());
